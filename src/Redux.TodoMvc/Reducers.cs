...
namespace Redux.TodoMvc
{
    public static class Reducers
    {
        ...
        public static ImmutableArray<Todo> TodosReducer(ImmutableArray<Todo> previousState, object action)
        {
        ...
        public static ApplicationState ReduceApplication(ApplicationState previousState, object action)
        {
